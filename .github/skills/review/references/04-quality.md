...
- **Outdated patterns.** Edition 2024 / Rust 1.94 is the floor — flag patterns superseded by current idioms: manual impls where `derive` suffices, pre-2024 borrow gymnastics, needless clones that clippy-pedantic would catch.
