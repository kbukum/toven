...
The rskit-reused vs toven-owned concern owners are documented in [`docs/concern-owners.md`](../../../../docs/concern-owners.md) — start there. For each candidate, locate the rskit owner in the `rskit/` submodule and confirm the new code calls it rather than reimplementing it:
