...
/// cache-significant version string; the engine folds it into the cache key. The
/// port keeps the planner pure so tests substitute a deterministic prober, and
/// the concrete subprocess adapter lives in the engine.
