//! `toven-engine-core` — the shared PLAN foundation below the engine.
//!
...
//! [`toven-engine-release`](../toven_engine_release/index.html) crates depend
//! downward on. Layering stays downward-only: this crate imports **no**
//! `toven-engine`, `toven-engine-release`, or `toven-cli` types.
//!
