...
//! invoking any forge (see [`rehearse`](crate::release_rehearse)); `--no-push` skips
...
use crate::model::tag;
use crate::{ReleasePlan, ReleaseStats, ReleaseTargets};
...
fn changelog_notes(changelog: &crate::ChangelogEntry) -> String {
