...
/// `[[members]]` array. Loading each member's own `toven.toml` and composing
/// the federated graph are federation responsibilities; this schema is parsed
/// and structurally validated during config loading.
