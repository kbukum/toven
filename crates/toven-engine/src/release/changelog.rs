...
use super::conventional::{ChangeGroup, classify};
...
#[must_use]
pub(super) fn entry(module: &Module, commits: &[CommitSummary], initial: bool) -> ChangelogEntry {
...
#[must_use]
pub(super) fn merge_notes(existing: &str, incoming: &str) -> String {
