...
use super::{ReleasePlan, ReleaseStats, changelog};
...
pub(crate) fn mutate_manifests(
    ...
    for entry in &plan.entries {
        let module = super::apply::module_for(module_by_ref, &entry.module)?;
        let target = super::apply::target_for(targets, module)?;
