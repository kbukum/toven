...
| [getting-started.md](getting-started.md) | Adopting Toven in a repository: onboard with the wizard, inspect, run, read cache decisions. |
| [product.md](product.md) | What Toven does, the core workflows, and the command surface at a glance. |
| [commands/](commands/README.md) | Command reference: init, run, inspect, and cache. |
